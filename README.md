...
![Dashboard]<img width="1317" height="930" alt="image" src="https://github.com/user-attachments/assets/9a76c589-facb-495b-8318-5815a81abb29" />
...
1. Revenue (MoM %)
2. Total Orders (MoM %)
3. Average Order Value (AOV) (MoM %)
4. Monthly comparisons (Current vs Previous Month)
...
3. Performed root cause analysis (basket size impact on AOV)
4. Developed a Power BI dashboard for performance tracking
5. Translated data into actionable business insights and recommendations
